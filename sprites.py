...
mainmenu_background=pygame.image.load('images/background.jpg')
...
all_sprites=[helicopter_1,helicopter_2,helicopter_damaged_1,helicopter_damaged_2,enemy_helicopter_1,enemy_helicopter_2,helicopter_crash_1,helicopter_crash_2,helicopter_crash_3,helicopter_crash_4,red_heart,missile,icon,mainmenu_background,mainmenu_helicopter,spikes,bg1,bg2]
